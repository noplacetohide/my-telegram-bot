    ...
    return (
        ...
        >
            <div className='flex justify-between items-center px-2 '>
                <div className={`flex flex-col justify-center items-center p-1 rounded-md w-14 h-12 `}>
                    <img src={ptap} width={256} height={256} alt="ptap" className='rounded p-0.25' />
